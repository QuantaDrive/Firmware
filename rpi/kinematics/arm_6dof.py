...
if __name__ == "__main__":
    ...
    coordinates, orientation = arm.forward_kinematics((sp.rad(0), sp.rad(0), sp.rad(0), sp.rad(0), sp.rad(0), sp.rad(0)), toolframe_matrix)
    ...
    j1_angle, j2_angle, j3_angle, j4_angle, j5_angle, j6_angle = arm.inverse_kinematics((coordinates[0], coordinates[1], coordinates[2], orientation[0], orientation[1], orientation[2]), toolframe_matrix)
